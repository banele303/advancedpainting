            ...
            <div className="px-[2rem]  mt-[6rem] md:mt-[2rem]">
              ...
              <div className="grid grid-cols-1  md:grid-cols-2 gap-6 pt-[7rem] md:pl-[3rem] md:h-[580px]">
                <div className="md:pl-[3rem]">
                  <h1 className="text-[20px] md:text-[35px] pt-[22rem] md:pt-[2rem] md:pt-1 leading-[2rem] md:leading-[3rem] text-slate-100 font-extrabold">
                  Residential, Commercial Interior Painting Services
                  </h1>
